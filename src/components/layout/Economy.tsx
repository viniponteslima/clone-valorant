				...
				<div className="dailyMission">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
						...
						<rect
							...
							width="115.743"
							height="115.743"
							transform="rotate(45 199.579 117.736)"
							className={styles.opacity50to100}
						/>
					</svg>
				...
				<div className="weekMission">
					...
					>
						...
						<circle
							...
							stroke="white"
							strokeWidth="20"
							className={styles.opacity0to50}
						/>
						<path
							d="M320 200.239C240.16 200.239 200.239 160.319 200.239 79C200.239 160.319 160.319 200.239 79 200.239C160.319 200.239 200.239 240.16 200.239 320C200.239 240.16 240.16 200.239 320 200.239Z"
							fill="white"
						/>
					</svg>
			...
			<div className={styles.nightMarket}>
				...
				>
					...
					<path
						...
						fillRule="evenodd"
						clipRule="evenodd"
						d="M281 56H118V344H281V56ZM200 128L128 200L200 272L272 200L200 128Z"
						fill="#DEDBD5"
					/>
				</svg>
			</div>
			...
			<div className={styles.coins}>
				...
				<div className={styles.points}>
					...
					>
						...
						<path
							d="M227.5 146C236.385 146 244.906 149.529 251.188 155.812C257.471 162.094 261 170.615 261 179.5C261 188.385 257.471 196.906 251.188 203.188C244.906 209.471 236.385 213 227.5 213L227.5 188.007C229.756 188.007 231.92 187.111 233.516 185.516C235.111 183.92 236.007 181.756 236.007 179.5C236.007 177.244 235.111 175.08 233.516 173.484C231.92 171.889 229.756 170.993 227.5 170.993L227.5 146Z"
							fill="white"
						/>
				...
				<div className={styles.points}>
					...
					>
						...
						<rect
							...
							width="212.87"
							height="148.818"
							transform="rotate(-45 72.1421 222.664)"
							fill="#ffffff"
							stroke="#ffffff80"
							strokeWidth="20"
							className={styles.opacity0to50}
						/>
						<path
							d="M135.403 248.74L135.408 193.145L164.403 163.74L164.33 219.404L135.403 248.74Z"
							fill="white"
						/>
						<path
							d="M178.403 205.74L178.408 150.145L207.403 120.74L207.33 176.404L178.403 205.74Z"
							fill="white"
						/>
						<path
							d="M180.909 202.74L226.864 248.74L185.903 248.74L160.461 223.188L180.909 202.74Z"
							fill="white"
						/>
					</svg>
